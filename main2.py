...
user_token = "Bearer u8xzkdpkgfc73uektn64, User a00f983961ea4937384c9dd60743362a"
...
def clientinfo(clid):
    ...
    headers = {
        ...
        'Cookie': '__cf_bm=pe9F_palK0i0KN6R3moZmywfMJPxwIuZjUtIHk5IXsc-1684252246-0-AbuwhHeIXtV+xvAlvftjTkNC8h/pqNXewB5Em+hT9CFmS7+6UnTh7KGqYnBi8eK9IuWT4GGZEGFiRhOJdduW69o=; _cfuvid=u2tO1fcriVVIX57v3TdevGSGYX6uzY1imRzbljP5.AE-1684252246338-0-604800000; app_service_group=9; auth=tighkh1pm7qebbknmuf02ksaf4idckk2fkh6rbm0ts5l658b9uv191fj5968e4t3; ycl_language_id=1'
    }
